$(document).ready( function() {
  ...
  const questionsAvailable = [35]; //exact number of question files in each directory
    ...
    var questionNumber = 34//Math.floor(Math.random() * questionsAvailable[subjectNumber]); //randomly picked question number
