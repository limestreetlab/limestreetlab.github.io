$(document).ready( function() {
  ...
  const questionsAvailable = [28]; //exact number of question files in each directory
    ...
    var questionNumber = 31//Math.floor(Math.random() * questionsAvailable[subjectNumber]); //randomly picked question number
