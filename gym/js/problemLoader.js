$(document).ready( function() {
  ...
  const questionsAvailable = [27]; //exact number of question files in each directory
    ...
    var questionNumber = 26 //Math.floor(Math.random() * questionsAvailable[subjectNumber]); //randomly picked question number
