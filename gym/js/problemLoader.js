$(document).ready( function() {
  ...
  const questionsAvailable = [33]; //exact number of question files in each directory
    ...
    var questionNumber = 32 //Math.floor(Math.random() * questionsAvailable[subjectNumber]); //randomly picked question number
