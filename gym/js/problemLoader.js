$(document).ready( function() {
  ...
  const questionsAvailable = [36]; //exact number of question files in each directory
    ...
    var questionNumber = 35//Math.floor(Math.random() * questionsAvailable[subjectNumber]); //randomly picked question number
