$(document).ready( function() {
  ...
  const questionsAvailable = [40]; //exact number of question files in each directory
    ...
    var questionNumber = 39//Math.floor(Math.random() * questionsAvailable[subjectNumber]); //randomly picked question number
