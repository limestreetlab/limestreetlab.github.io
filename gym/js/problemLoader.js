$(document).ready( function() {
  ...
  const questionsAvailable = [26]; //exact number of question files in each directory
    ...
    var questionNumber = 25 //Math.floor(Math.random() * questionsAvailable[subjectNumber]); //randomly picked question number
