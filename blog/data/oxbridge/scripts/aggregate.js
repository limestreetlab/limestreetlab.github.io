...
*/
//INPUT: latest Cambridge filepath and data fields
fs.createReadStream("/Users/houghtonstreet/Dropbox/Lime Street/limestreetlab.github.io/blog/data/oxbridge/extracted/cambridge_2025.csv", { encoding: "utf-8" })
  .pipe(parser({skipLines: 1, headers: ["ucas", "school", "postcode", "status", "cambridge_application_2025", "cambridge_offer_2025"]}))
  .on("data", (line) => {
    let offerRate = Math.round( (line.cambridge_offer_2025 / line.cambridge_application_2025)*100 );
    line.cambridge_success_2025 = !isNaN(offerRate) ? offerRate + "%" : "";
    line.status = (line.status.toLowerCase() == "independent") ? "Private" : "Public"; 
    data.push(line);
  })
  .on("end", () => {
    //INPUT: Cambridge filepaths and data fields prior to the latest year and Oxford ones including the latest year
    let promise = addData("/Users/houghtonstreet/Dropbox/Lime Street/limestreetlab.github.io/blog/data/oxbridge/extracted/cambridge_2024.csv", "cambridge", 2024);
    promise.then( function() {
      return addData("/Users/houghtonstreet/Dropbox/Lime Street/limestreetlab.github.io/blog/data/oxbridge/extracted/cambridge_2023.csv", "cambridge", 2023);
    }).then( function() {
      ...
      return addData("/Users/houghtonstreet/Dropbox/Lime Street/limestreetlab.github.io/blog/data/oxbridge/extracted/oxford_2025.csv", "oxford", 2025);
    }).then( function() {
